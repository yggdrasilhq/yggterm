...
def resource_process_category(row: dict[str, Any], *, yggterm_home: str | None) -> str:
    ...
    if proc_home == "/home/user/.yggterm" or "/.local/share/yggterm/direct/versions/" in cmd:
    ...
    *,
    ...
    return {
        ...
        "category_hints": {
            ...
            "live_yggterm_home": "/home/user/.yggterm",
        },
        "baseline": baseline,
...
def main() -> int:
    ...
    parser.add_argument("--remote-base-dir", default="/home/user/.cache")
    ...
    parser.add_argument("--local-cwd", default="/home/user")
    parser.add_argument("--remote-cwd", default="/home/user")
    ...
    remote_base_dir = args.remote_base_dir.rstrip("/") or "/home/user/.cache"
