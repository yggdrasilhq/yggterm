...
install -m 0755 "$YNPM_BIN_PATH" "$STAGE_DIR/usr/lib/yggterm/ynpm-bin"
...
ln -s /usr/lib/yggterm/ynpm-bin "$STAGE_DIR/usr/bin/ynpm"
ln -s /usr/lib/yggterm/ynpm-bin "$STAGE_DIR/usr/bin/ynpx"
