...
## Verification
- `yggterm-headless server titles ls --json --limit 10000` → `openclaw 334 live 37` top `muse d703a4e1`, `7a319776`, `d68614ac`; `jojo 714 live 54` top `muse 6ff56abf`.
- `cwdtree 334 groups 24` / `714 groups 58` with `M_` in `~/gh/yggterm`; `startpage` same durable.
- Raw `find`+`sqlite3` vs verb: `openclaw 328 raw vs 334 verb (+4)`, `jojo 730 raw vs 714 verb (-16)` – all oracles `OK`.
