...
fn print_server_app_help() {
  ...
  yggterm-headless server app row-set <row-path> [--into <head>|--out|--dissolve|--reset]
  ...
  yggterm-headless server app sessions restore <session-path>... [--dry-run] [--include-closed]
  ...
  yggterm-headless server app launch-app <app> [verb] [--cwd <dir>] [--insert-after <session-path>]
