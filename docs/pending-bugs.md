...
`/home/user/data/cases-debug-cli`, `/home/user/data/cases-debug-movefix`, and an
...
failure redirects to `$HOME`. Measured for the three restored sessions:
    ...
    /home/user/data/cases-debug-cli                → /home/user/data
    /home/user/data/cases-debug-movefix            → /home/user/data
    /mnt/netshare/…/dada/obsidian/codex/yggterm     → /mnt/netshare/…/dada/obsidian
...
2. **Distinct sessions collapse onto one location.** Both 181-turn sessions land
   in `/home/user/data`, so the cwd no longer distinguishes them.
