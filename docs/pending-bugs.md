...
**Measured on guihost (3.0.53), the same page read three times with a DIFFERENT ROW
SELECTED each time.** Nothing else changed between readings:

| selected row's scope | header says | rows the DOM carried |
|---|---|---|
| `dev` · `/home/user/gh/yggterm` | **188 shown** | 12 rendered |
| `dev` · `/home/user/git/jyas` | **40 shown** | 12 rendered |
| `dev` · `/home/user/data/vaultgraph/git/graph-manager` | **4 shown** | 4 rendered |
