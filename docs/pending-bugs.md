...
- **★★★ `web do` FIDELITY ON RE-RENDERING DOMs — three reproducible defects,
  one family (a services portal filing run, 2026-07-26 ~15:30-16:00 IST, jojo 2.12.15,
  ...
  **STATUS 2026-07-26 — ALL FIVE HALVES ARE CODE-FIXED, NONE LIVE-VERIFIED.**
  ...
  ⚠ **Live verification is OWED**: no a services portal re-run, no jojo deploy. The
