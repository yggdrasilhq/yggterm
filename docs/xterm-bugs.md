...
**STATUS:** REOPENED 2026-05-28 (was claimed FIXED; live verification on guihost showed `base_y: 0` in xterm.js, scrollbar empty, user couldn't scroll). Two distinct gaps below.
