...
GPL-2.0-only, or proprietary terms. The judgement calls — Apache-2.0's one-way
compatibility, MPL-2.0 §3.3, and the OpenSSL 3.x-versus-1.x question — are
reasoned through in `THIRD-PARTY-NOTICES.md`, which is the document to read;
this one is the evidence behind it.

The eight `GPL-3.0-or-later` rows are yggterm's OWN crates. The three
libyggterm crates it links — `yggui`, `yggui-contract`, `emd-renderer` — read
`MPL-2.0`, which is the arrangement the split exists to produce and is
permitted precisely because plain MPL carries no Exhibit B. Before 2026-08-02
this file listed them as GPL at version 2.12.23, which was simply stale: it
had not been regenerated since they left the workspace.
...
y4m: 0.8.0, "MIT",
yggterm: 3.0.0, "GPL-3.0-or-later",
yggterm-core: 3.0.0, "GPL-3.0-or-later",
yggterm-ghostty-bridge: 3.0.0, "GPL-3.0-or-later",
yggterm-gtk-glue: 3.0.0, "GPL-3.0-or-later",
yggterm-platform: 3.0.0, "GPL-3.0-or-later",
yggterm-server: 3.0.0, "GPL-3.0-or-later",
yggterm-shell: 3.0.0, "GPL-3.0-or-later",
yggterm-webprobe: 3.0.0, "GPL-3.0-or-later",
yggui: 0.3.0, "MPL-2.0",
yggui-contract: 0.3.0, "MPL-2.0",
