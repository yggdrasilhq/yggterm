...
Before updating critical clients such as guihost, run the update protocol in an
...
## 2.2.50 Guihost Incident Class

On 2026-05-13, updating guihost from 2.2.49 to 2.2.50 relaunched the GUI on
...
- New GUI path:
  `/home/user/.local/share/yggterm/direct/versions/2.2.50/yggterm`
