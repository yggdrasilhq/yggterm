...
Convert "ship to guihost and hope; the user finds it broken" into "a red test before
...
app-control (already half-built on guihost), screenshot + assert. Reserved for genuine
