...
/// makes the whole check useless. Three live Claude Code composers on guihost
/// (2026-08-07), raw:
///
/// ```text
...
";
    ...
    /// copied verbatim from `guihost:/proc/meminfo` and `guihost:/proc/pressure/memory`
  ...
  gpt-5.4 high fast · 100% left · ~/git",
    ...
    fn terminal_chunk_marks_stale_yggterm_socket_connect_error_as_transport_error() {
        let data = "╭─────────────────────────────────────────────╮\n\
               ...
               ╰─────────────────────────────────────────────╯\n\
                                                              Error: connecting to /home/user/.yggterm/server-2-\n\
1-10.sock\n\n\
Caused by:\n\
...
tGPT
  ...
  Press enter to continue";
    ...
    #[test]
    fn terminal_host_problem_rejects_guihost_sparse_prompt_after_update() {
...
╰────────────────────────────────────────────────────────╯"
    ...
    /// codex's `›`. Live on guihost 2026-08-06: the delegate row showed
    ...
    /// line captured off guihost's daemon screen on 2026-08-07 — because the first
    ...
    ///
    /// All three footers are VERBATIM from one guihost snapshot on 2026-08-07 —
  ...
  gpt-5.5 medium · ~/gh/yggterm";
    ...
    fn terminal_host_problem_accepts_input_enabled_remote_tail_with_meaningful_output() {
        ...
        let host = json!({
            ...
            "text_sample": "The final 2.1.59 artifacts are built. Before replacing the live guihost install, I’m taking one more runtime/install snapshot.",
            "text_tail": "The final 2.1.59 artifacts are built. Before replacing the live guihost install, I’m taking one more runtime/install snapshot.",
