...
#HttpOnly_forms.example.gov\tFALSE\t/\tTRUE\t0\tPHPSESSID\tq7v2n8m4k1
...
";
    ...
    fn a_curl_written_jar_round_trips_including_the_http_only_prefix() {
        ...
        assert_eq!(session.domain, "forms.example.gov");
        assert!(
            session.http_only,
        ...
        assert!(written.contains("#HttpOnly_forms.example.gov\t"));
