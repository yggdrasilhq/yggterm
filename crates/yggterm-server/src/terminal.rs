...
impl PtySessionRuntime {
    ...
    fn resize(&self, cols: u16, rows: u16) -> Result<()> {
        ...
        // Live on jojo 2026-07-25: a 168x63 PTY whose model still rendered to
...
mod screen_width_tests {
    ...
    /// The exact shape the daemon serves (measured live on jojo 2026-07-25):
...
\x1b[1;10H\x1b[K\r\x1b[1Bmid-frame relative move\x1b[K";
    ...
    fn launch_command_detects_remote_resume_attach() {
        let launch_command = "ssh -tt jojo 'exec $HOME/.yggterm/bin/yggterm '\\''server'\\'' '\\''remote'\\'' '\\''resume-codex'\\'' '\\''019ce5d8-c94c-7b62-ae19-3818ae400b65'\\'' '\\''/home/user'\\'''";
        let start_command = "ssh -tt jojo 'exec $HOME/.yggterm/bin/yggterm '\\''server'\\'' '\\''remote'\\'' '\\''start-codex'\\'' '\\''019ce5d8-c94c-7b62-ae19-3818ae400b65'\\'' '\\''/home/user'\\'''";
    ...
    fn remote_resume_attach_shell_command_preserves_tty_settle_prefix() {
        let launch_command = "__yggterm_initial_tty_size=$(stty size 2>/dev/null || true); unset __yggterm_initial_tty_size; exec ssh -tt jojo 'exec $HOME/.yggterm/bin/yggterm '\\''server'\\'' '\\''remote'\\'' '\\''resume-codex'\\'' '\\''test-session'\\'' '\\''/home/user'\\'''";
    ...
    fn remote_resume_attach_shell_command_execs_plain_ssh_command() {
        let launch_command = "ssh -tt jojo 'exec $HOME/.yggterm/bin/yggterm '\\''server'\\'' '\\''remote'\\'' '\\''resume-codex'\\'' '\\''test-session'\\'' '\\''/home/user'\\'''";
    ...
    fn runtime_owned_terminal_keys_prefer_initial_screen_snapshot() {
        ...
        assert!(terminal_key_prefers_initial_screen_snapshot(
            "local://legacy-resume",
            "ssh -tt jojo 'exec $HOME/.yggterm/bin/yggterm '\\''server'\\'' '\\''remote'\\'' '\\''resume-codex'\\'' '\\''test-session'\\'' '\\''/home/user'\\'''",
        ));
        assert!(terminal_key_prefers_initial_screen_snapshot(
            "local://fresh-start",
            "ssh -tt jojo 'exec $HOME/.yggterm/bin/yggterm '\\''server'\\'' '\\''remote'\\'' '\\''start-codex'\\'' '\\''test-session'\\'' '\\''/home/user'\\'''",
        ));
        assert!(!terminal_key_prefers_initial_screen_snapshot(
            "local://plain",
            "bash -lc 'sleep 30'",
