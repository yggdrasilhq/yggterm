...
impl DaemonRuntime {
    ...
    /// adopted anyway, forever — jojo 2026-07-26 showed 22 rows adopted from a
    ...
    ///   bare-`restore_live_session` each row, which appends: measured on jojo
...
mod tests {
    ...
    fn peer_live_row_admission_refuses_husks_without_refusing_agent_rows() {
        ...
        // The live jojo case: a loopback plain Shell that NO daemon owns. No
