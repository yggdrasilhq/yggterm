...
mod tests {
    ...
    fn low_signal_copy_rejects_ansi_shell_prompt_text() {
        assert!(crate::looks_like_low_signal_generated_copy(
            "\u{1b}[32;1mpi@guihost\u{1b}[m:\u{1b}[34;1m~\u{1b}[m$"
        ));
    }
    ...
    fn manual_summary_and_alias_copy_share_session_title_store() -> Result<()> {
        ...
        store.put_manual_summary("synthetic-runtime", "/home/user/gh/yggterm", "Manual summary")?;
    ...
    fn best_effort_summary_ignores_target_command_scaffold() {
        ...
        assert!(!summary.contains("Target: /home/user"));
    ...
    fn best_effort_copy_handles_short_substantive_user_context() {
        ...
        let context = [
            "RECENT SUBSTANTIVE TURNS:",
            "USER: Investigate the SAMPLENOTES extraction workflow.",
        ]
        .join("\n");
        let title = best_effort_title_from_context(&context).expect("title");
    ...
    fn best_effort_title_prefers_theme_over_shell_noise() {
        let context = [
            ...
            "",
            "RECENT SUBSTANTIVE TURNS:",
            "USER: guihost is this machine. manin is what I asked you for.",
