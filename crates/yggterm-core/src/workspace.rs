...
mod tests {
    ...
    fn rewrites_legacy_workspace_paths() {
        assert_eq!(
            rewrite_legacy_workspace_path("/local/home/user/gh/notes/separator-1"),
            "/home/user/gh/notes/separator-1"
        );
        assert_eq!(
            rewrite_legacy_workspace_path("/home/user/gh/notes/notes/untitled-1"),
            "/home/user/gh/notes/untitled-1"
        );
    }
    ...
    fn simplifies_compounded_workspace_order_paths() {
        assert_eq!(
            simplify_workspace_order_path(
                "/home/user/gh/notes/0000-0008-0000-untitled-1774119990~0002-0002-0001-note"
            ),
            "/home/user/gh/notes/0000-untitled-1774119990~0002-note"
        );
        assert_eq!(
            simplify_workspace_order_path(
                "/home/user/gh/notes/!0000-0000-separator-1774185969049440371"
            ),
            "/home/user/gh/notes/!0000-separator-1774185969049440371"
        );
    }
}
