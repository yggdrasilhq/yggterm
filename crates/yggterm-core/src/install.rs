...
/// the hour.** After the first guard shipped, the record on guihost read:
///
/// ```text
...
mod handoff_target_tests {
    ...
    // this is the ordinary guihost/dev shape after the mitigation.
    #[test]
...
mod handoff_version_tests {
    ...
    // The live failure, as a test: guihost ran 3.0.43 and its install state named
...
mod tests {
    ...
    fn launcher_file_detects_dev_build_fallback_as_stale() {
        ...
        let contents =
            "# yggterm-direct-launcher-v3\nexec '/home/user/gh/yggterm/target/debug/yggterm'\n";
    ...
    fn linux_launcher_routes_server_commands_to_headless_except_app_launch() {
        let context = InstallContext {
            ...
            executable_path: PathBuf::from(
                "/home/user/.local/share/yggterm/direct/versions/2.1.52/yggterm",
            ),
            preferred_executable: Some(PathBuf::from(
                "/home/user/.local/share/yggterm/direct/versions/2.1.52/yggterm",
            )),
            managed_root: Some(PathBuf::from("/home/user/.local/share/yggterm/direct")),
            manager_hint: Some("Direct install".to_string()),
        };
  ...
  "active_executable": "/home/user/.local/share/yggterm/direct/versions/2.6.46/yggterm",
  "version": "2.6.47",
  "executable_path": "/home/user/.local/share/yggterm/direct/versions/2.6.47/yggterm",
  "headless_path": "/home/user/.local/share/yggterm/direct/versions/2.6.47/yggterm-headless",
  "icon_revision": "2.6.46"
        ...
        assert_eq!(
            ...
            PathBuf::from("/home/user/.local/share/yggterm/direct/versions/2.6.47/yggterm")
        );
    ...
    fn linux_desktop_entry_uses_theme_icon_and_canonical_wm_class() {
        ...
        let legacy = linux_desktop_entry_contents(Path::new("/home/user/.local/bin/yggterm"), true);
