...
3. Capture:
   ...
   - for inline rename bugs, include `shell.tree_rename_value`, `dom.tree_rename_input_value`, `dom.tree_rename_input_focused`, and any `snapshot_mode == "action-fallback"` evidence if KDE forced a degraded snapshot
